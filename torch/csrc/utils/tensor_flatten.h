...
void reorder_tensors_like(std::vector<at::Tensor>& tensors, const at::TensorList& order);

std::pair<at::Tensor, at::Tensor> flatten_sparse_tensors(const at::TensorList& tensors);
